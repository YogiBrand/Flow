/*
  # AI Agent Templates and Resources Migration

  1. New Tables
    - `tool_templates` - Available tool templates with configurations
    - `platform_templates` - Social media platform configurations  
    - `knowledge_base_templates` - Pre-built knowledge base templates
    - `resource_templates` - Reusable content and workflow templates
  ...
  3. Data
    - Insert comprehensive tool templates
...
-- Insert Knowledge Base Templates (using proper array syntax)
...
-- Insert Resource Templates (using proper array syntax)
