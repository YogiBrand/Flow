/*
  ...
  1. New Tables
    - `ai_agents` - Core agent information with chat/memory/execution settings
    ...
    - `agent_escalations` - Escalation rules and conditions
    - `agent_variables` - Custom variables for agents
    - `agent_metadata` - Additional metadata storage
