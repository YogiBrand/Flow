...
DO $$
BEGIN
  -- Drop and recreate policies for ai_agents
  ...
  -- Drop and recreate policies for agent_knowledge_bases
  DROP POLICY IF EXISTS "Users can manage knowledge for their agents" ON agent_knowledge_bases;
  ...
  -- Drop and recreate policies for agent_tools
  DROP POLICY IF EXISTS "Users can manage tools for their agents" ON agent_tools;
  ...
  -- Drop and recreate policies for agent_prompts
  DROP POLICY IF EXISTS "Users can manage prompts for their agents" ON agent_prompts;
  ...
  -- Drop and recreate policies for agent_triggers
  DROP POLICY IF EXISTS "Users can manage triggers for their agents" ON agent_triggers;
  ...
  -- Drop and recreate policies for agent_escalations
  DROP POLICY IF EXISTS "Users can manage escalations for their agents" ON agent_escalations;
  ...
  -- Drop and recreate policies for agent_variables
  DROP POLICY IF EXISTS "Users can manage variables for their agents" ON agent_variables;
  ...
  -- Drop and recreate policies for agent_metadata
  DROP POLICY IF EXISTS "Users can manage metadata for their agents" ON agent_metadata;
