/*
  # Templates and Resources Schema

  1. New Tables
    - `tool_templates` - Templates for agent tools
    - `platform_templates` - Social media platform definitions
    - `knowledge_base_templates` - Pre-built knowledge bases
    - `resource_templates` - Reusable content templates
