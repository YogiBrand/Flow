...
-- Insert Tool Templates (only if they don't exist) - Fixed JSONB casting
DO $$
BEGIN
    -- Web Scraping Tools
...
-- Insert Platform Templates (only if they don't exist) - Fixed JSONB casting
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM platform_templates WHERE platform_key = 'instagram_platform') THEN
        ...
        ('Instagram', 'instagram_platform', 'Connect and manage Instagram business accounts for content posting and analytics', '📷', 'https://graph.facebook.com/v18.0', 'oauth',
...
5. Performance Measurement
   ...
   - Adjust strategy based on data',
    ...
    IF NOT EXISTS (SELECT 1 FROM knowledge_base_templates WHERE name = 'Lead Generation Strategies') THEN
        INSERT INTO knowledge_base_templates (name, category, description, content_type, content, metadata, tags) VALUES
...
5. Lead Qualification and Nurturing
   ...
   - Align sales and marketing teams',
    ...
    IF NOT EXISTS (SELECT 1 FROM knowledge_base_templates WHERE name = 'Customer Support Best Practices') THEN
        INSERT INTO knowledge_base_templates (name, category, description, content_type, content, metadata, tags) VALUES
...
- Match subject line to email content',
    ...
    IF NOT EXISTS (SELECT 1 FROM resource_templates WHERE name = 'Brand Voice Guidelines Template') THEN
        INSERT INTO resource_templates (name, type, description, content, category, metadata, tags) VALUES
...
7. Voice Checklist
   ...
   - Will our audience connect with this?',
    ...
    IF NOT EXISTS (SELECT 1 FROM resource_templates WHERE name = 'Content Calendar Template') THEN
        INSERT INTO resource_templates (name, type, description, content, category, metadata, tags) VALUES
...
- Follower growth',
    ...
    IF NOT EXISTS (SELECT 1 FROM resource_templates WHERE name = 'Lead Magnet Template') THEN
        INSERT INTO resource_templates (name, type, description, content, category, metadata, tags) VALUES
